                    ...
                    SizedBox(
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          controller: adminController.projectTitleController,
                          validator: (value) {
                    ...
                    SizedBox(
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          controller:
                              adminController.projectDescriptionController,
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                    ...
                    adminController.usersList.isEmpty
                        ...
                        : SizedBox(
                            ...
                            child: MultiSelectDialogField(
                              ...
                              onConfirm: (values) {
                                adminController.selectedUsers.value = values;
                              },
                            ),
                          ),
                    const SizedBox(
                                      ...
                                      TextButton(
                                        onPressed: () async {
                                          ...
                                          if (adminController
                                            ...
                                            // await adminController.addProject(
                                            //     adminController
                                            //         .projectTitleController
                                            //         .text,
                                            //     adminController
                                            ...
                                            //         .text,
                                            //     adminController
                                            //         .thumbnail_url.value as XFile,
                                            //     adminController.selectedUsers);
                                            Get.back();
                                            Get.back();
