    ...
    return GetX<NotificationController>(
        builder: (controller) => Scaffold(
            ...
            body: RefreshIndicator(
                      ...
                      strokeWidth: 3.0,
                      onRefresh: () async {
                       await tasksController.getTasksByProject(projectController.singleProjectList[0].id);
              ...
              child: tasksController.tasksByProjectList.isEmpty
                  ? Container(
                      height: Height,
                        ...
                        children: [
                          ...
                          SizedBox(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemCount:
                                      tasksController.tasksByProjectList.length,
